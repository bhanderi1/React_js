                            ...
                            (
                                ...
                                <div className='flex h-screen bg-gray-400 justify-center items-center'>
                                    <div className='bg-pink-500 p-12 border-4 border-solid border-black'>
                                        <figcaption className='text-center font-bold'></figcaption>
                                        <div className='mt-4'>
                                        ...
                                        <button className='bg-gray-600 w-full mt-4 text-white  border-white border-2 py-[10px] font-bold hover:border-2 hover:border-solid hover:border-black hover:text-black hover:bg-blue-200' onClick={handleClick}>SignUp</button>
                                    </div>
                                </div>
                            )
