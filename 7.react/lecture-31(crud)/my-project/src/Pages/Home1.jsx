      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-4">
        <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
          ...
          <div className=" max-lg:mt-2 border-[1px] border-gray-300 rounded-3xl px-5 py-2 outline-none flex items-center">
            ...
            <input type="search" placeholder="search" className="outline-none"/><br className="lg:hidden"/>
            </div>
          <div>
            <Link to='/add'>
            <button
                  ...
                  <tbody className="divide-y divide-gray-200 bg-white" key={value.id}>
                     <tr>
                      ...
                      <td className="whitespace-nowrap px-4 py-4 text-right text-sm font-medium">
                        <Link to='/EditUser'><button className="bg-gray-300 px-[20px] py-[8px] me-[10px]  rounded-lg hover:bg-black hover:text-white">
                          Edit</button>
                        </Link>
